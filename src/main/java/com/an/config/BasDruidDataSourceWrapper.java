...
public class BasDruidDataSourceWrapper extends DruidDataSource implements InitializingBean {
  /**
   * serialVersionUID:TODO用一句话描述这个变量表示什么.
   * @since JDK 1.8
   */
  private static final long serialVersionUID = -7621048420708030933L;
  @Autowired
